...
public class FunctionsTest {
	...
	@Before
	/**
	 * This atomcntainer is built as the example input for all the test cases.
	 * @throws Exception
	 */
	 ...
	 * The equivalence classes are enumarated based on implicit hydrogens and symmetry values
	 * of the atoms. 
	 * 
